      ...
      <div className="container footer-container">
        <div className="footer-brand">
          <Link to="/" className="footer-logo font-sans-display text-brown" style={{ fontSize: '24px', display: 'flex', alignItems: 'center', gap: '12px', textDecoration: 'none' }}>
            ...
            <span style={{ lineHeight: 1.2, fontWeight: 900, WebkitTextStroke: '2px currentColor', textShadow: '0 0 1px currentColor', letterSpacing: '0.5px' }}>Geeta Science<br />Inter College</span>
          </Link>
