    ...
    <nav className="navbar">
      <div className="container navbar-container">
        <Link to="/" className="navbar-logo font-sans-display text-brown" style={{fontSize: '22px', display: 'flex', gap: '8px', alignItems: 'center'}}>
          ...
          <span className="nav-logo-text-full" style={{ fontWeight: 900, WebkitTextStroke: '2px currentColor', textShadow: '0 0 1px currentColor', letterSpacing: '0.5px' }}>Geeta Science Inter College</span>
        </Link>
